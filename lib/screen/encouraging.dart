...
class Encouraging extends StatefulWidget {
  const Encouraging({super.key});

  @override
  State<Encouraging> createState() => _EncouragingState();
}

class _EncouragingState extends State<Encouraging> {
