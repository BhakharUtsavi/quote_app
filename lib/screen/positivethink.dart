...
class PositiveThinking extends StatefulWidget {
  const PositiveThinking({super.key});

  @override
  State<PositiveThinking> createState() => _PositiveThinkingState();
}

class _PositiveThinkingState extends State<PositiveThinking> {
